import { Dropdown, MessageBar, MessageBarType, DialogFooter, PrimaryButton, ProgressIndicator, TextField, Toggle, DefaultButton } from '@fluentui/react';
        ...
        <Grid item xs={12} md={9} lg={9}>
          <Paper>
            ...
            <GenericTable data={actvities.map(item=>{
              return {...item,action:<DefaultButton onClick={() => history.push('/QualificationManager/Activity/' + item.id)} text='View' />,}
            })}
